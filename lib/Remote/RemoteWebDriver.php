...
use Bonwe\WebDriver\Interactions\WebDriverActions;
use Bonwe\WebDriver\JavaScriptExecutor;
use Bonwe\WebDriver\WebDriver;
use Bonwe\WebDriver\WebDriverBy;
use Bonwe\WebDriver\WebDriverCapabilities;
use Bonwe\WebDriver\WebDriverCommandExecutor;
use Bonwe\WebDriver\WebDriverElement;
use Bonwe\WebDriver\WebDriverHasInputDevices;
use Bonwe\WebDriver\WebDriverNavigation;
use Bonwe\WebDriver\WebDriverOptions;
use Bonwe\WebDriver\WebDriverWait;
...
class RemoteWebDriver implements WebDriver, JavaScriptExecutor, WebDriverHasInputDevices
{
    ...
    public function findElements(WebDriverBy $by)
    {
        ...
        foreach ($raw_elements as $raw_element) {
            foreach ($raw_element as $value){
                $elements[] = $this->newElement($value);
            }
        }
